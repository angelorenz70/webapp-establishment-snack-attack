<div class="section" id="announcement" style="background-color: #6a040f">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-md-0 me-5" style="width: 8% height: 20%; overflow: hidden">
                                    ...
                                    <div class="container" style="overflow: hidden" >
                                        <img src="{{ asset('images/' . $announcement->image) }}" style="width: 100%; height:100%;  object-fit:cover; border-style: inset;" class="image-thumbnail" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
